  ...
  return (
    <>
      ...
      <main>
                  ...
                  <div className="flex flex-wrap justify-center text-center mb-24">
                    <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                      ...
                      <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600">
                        Pilihlah Baju Yang Ingin Kalian Pesan, Pesan Baju
                        Sekarang Juga
                      </p>
                      <Link href="/catalog">
              ...
              <div className="w-full md:w-5/12 ml-auto mr-auto px-4">
                <div className="md:pr-12">
                  ...
                  <h3 className="text-3xl font-semibold">
                    Kenapa Memilih Sweeta Collection?
                  </h3>
                  <p className="mt-4 text-lg leading-relaxed text-blueGray-500">
                    Sweeta Collection adalah usaha yang berkecimpung di bidang
                    tata rias, wisuda, tari, karnaval dan tempat persewaan
                    kostum.
                  </p>
                  <ul className="list-none mt-6">
                    ...
                    <li className="py-2">
                      <div className="flex items-center">
                        ...
                        <div>
                          <h4 className="text-blueGray-500">Pemesanan Cepat</h4>
                        </div>
                      </div>
                    </li>
                    <li className="py-2">
        ...
        <hr className="px-3"></hr>
        <section className="pt-20 pb-48 ">
          <div className="container mx-auto px-">
            <div className="flex flex-wrap justify-center text-center mb-24">
              <div className="w-full lg:w-6/12 px-4">
                <h2 className="text-4xl font-semibold">TIM PENGEMBANG</h2>
            ...
            <div className="flex flex-wrap">
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  ...
                  />
                  <div className="pt-6 text-center">
                    <h5 className="text-xl font-bold">Alfian Septy Candra</h5>
                    <p className="mt-1 text-sm text-blueGray-400 uppercase font-semibold">
                      Founder and CEO
                    </p>
                    <div className="mt-6">
              ...
              <div className="w-full md:w-6/12 lg:w-2/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  ...
                  />
                  <div className="pt-6 text-center">
                    <h5 className="text-xl font-bold">Muhammad Naslur</h5>
                    <p className="mt-1 text-sm text-blueGray-400 uppercase font-semibold">
                      Consumption Section
                    </p>
                    <div className="mt-6">
